...
export const runs = pgTable(
  "runs",
  {
    ...
    capabilitySnapshot: jsonb("capability_snapshot").$type<CapabilityRegistry>(),
    rootEntityId: uuid("root_entity_id"),
    researchWaveCount: integer("research_wave_count").notNull().default(0),
    researchWaveState: jsonb("research_wave_state").$type<Record<string, unknown>>().notNull().default({}),
...
export const providerCalls = pgTable(
  "provider_calls",
  {
    ...
    semanticTool: text("semantic_tool"),
    ...
    reusedFromCallId: uuid("reused_from_call_id"),
