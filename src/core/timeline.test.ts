...
test("timeline distinguishes reported, self-supported, corroborated, and conflicting observations", () => {
  const observations = [
    ...
    { id: "independent", artifactId: "a3", field: "employer", value: "Organization Alpha", validFrom: "2020-01-01", validTo: "2022-01-01" },
  ...
  const result = deriveTimelineStates(observations, [
    ...
    { artifactId: "a3", relation: "SUPPORTS", sourceAuthority: "FIRST_PARTY_INSTITUTIONAL", attestationGroup: "domain:organization.test" },
  ]);
