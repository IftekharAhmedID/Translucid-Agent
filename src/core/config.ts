...
const environmentSchema = z
  .object({
    ...
    FINALIZER_MODEL: z.string().min(1).default("deepseek-v4-pro"),
    FINALIZER_AUDITOR_MODEL: z.string().min(1).default("minimax-m3"),
...
export function loadConfig(environment: Record<string, string | undefined>) {
  ...
  return {
    ...
    finalizerAuditorModel: parsed.FINALIZER_AUDITOR_MODEL,
